...
import { ShieldPlus, Factory, Compass, Layers } from "lucide-react";

const items = [
  { title: "Expanding ROM supply security", icon: Layers },
  { title: "Increasing beneficiation capacity beyond Wolfmountain", icon: Factory },
  { title: "Extending reserve life through exploration", icon: Compass },
  { title: "Developing additional processing assets", icon: ShieldPlus },
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h3 className="mt-5 text-2xl font-semibold text-white sm:text-3xl">
            Capital-efficient growth with clear operational alignment.
          </h3>
