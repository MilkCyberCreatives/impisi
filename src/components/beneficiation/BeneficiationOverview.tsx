        ...
        >
          <div className="lg:col-span-7">
            ...
            <h2 className="mt-5 text-balance text-3xl font-semibold tracking-tight text-white sm:text-4xl">
              Converting run-of-mine material into market-ready products.
            </h2>

            <p className="mt-5 text-sm leading-relaxed text-white/75 sm:text-base">
              Mineral processing and beneficiation form a core value creation strategy, enabling the conversion of
              run-of-mine material into market-ready products.
            </p>

            <p className="mt-4 text-sm leading-relaxed text-white/75 sm:text-base">
              Beneficiation is structured to maximise recovery, improve concentrate quality, and increase margins,
              while reducing waste and environmental impact.
            </p>

            <div className="mt-8 h-px w-full bg-white/10" />
            <div className="mt-6 text-sm text-white/75">
              Owned & Operated Asset: Wolfmountain Chrome Wash Plant.
            </div>
          </div>
          ...
          >
            <div className="relative h-[320px] w-full sm:h-[360px]">
              <Image
                ...
                alt="Beneficiation and processing"
                fill
